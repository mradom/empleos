// $Id: video_upload_browser.js,v 1.1.2.4 2008/05/23 17:27:30 jhedstrom Exp $

/**
 * Rename file field name to YouTube requirements on submit
 */
Drupal.videoUploadAutoAttach = function() {
...
if (Drupal.jsEnabled) {
  $(document).ready(Drupal.videoUploadAutoAttach);
}
