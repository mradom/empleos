...
if(!$user->uid){?>
	<div id="login">
		<ul class="log">
			...
			<li class="destacar">
				<a title="Registrarse como empleador" href="/user/register/empleador"><span style="color:#FFF">Registro Empleadores</span>
...
<?php }else{?>
	<div id="login">
		<ul class="log">
			...
			<li><a title="Contacto" href="/contact">Contacto</a></li>
			<li class="destacar"><a title="Registrarse como empleador" href="/user/register/empleador"><span style="color:#FFF">Ingreso Empleadores</span></a>&nbsp;&nbsp;&nbsp;&nbsp;<a title="Preguntas frecuentes" href="/faq">C&oacute;mo publico un aviso?</a>
			</li>
		</ul>
	</div>
<?php }?>