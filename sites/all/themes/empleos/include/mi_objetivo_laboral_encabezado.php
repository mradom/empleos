				...
				<TABLE class="tablaGris" border="0" cellpadding="0" cellspacing="1"> 
				      <TBODY> 
				        <TR> 
				          ...
				          <TD class="techo" width="20%">Jerarquia</TD>
				          <TD class="techo" width="20%">Area</TD>
				          <TD class="techo" width="24%">Disponibilidad</TD> 				          
				          <TD class="techo" width="20%">Sueldo</TD>
				          <TD class="techo" width="16%">Pais/Provincia</TD>  
				        </TR> 
			<?php
