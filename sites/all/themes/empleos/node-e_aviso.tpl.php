...
<div class="box central ficha">
	...
	<ul class="resumen">
		...
		<li><span class="blue">Ramo o actividad:</span> Indumenaria infantil</li>
		<li><span class="blue">Lugar de trabajo:</span> <?php echo $nodo->taxonomy[$localidad]->name;?></li>
		<li><span class="blue">Jerarqu&iacute;a:</span> <?php echo $nodo->taxonomy[$area]->name;?></li>
		<li><span class="blue">Sector:</span> <?php echo $nodo->taxonomy[$sector]->name;?></li>
