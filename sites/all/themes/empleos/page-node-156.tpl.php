...
<div id="wrapper">
  ...
  <div id="midle">
       ...
       <!-- Simple -->
       <div class="left aviso" style="background:url(/sites/all/themes/empleos/img/a-simple.gif)top no-repeat;">
       		<ul class="left" style="margin-left:22px; margin-top:50px;">
       ...
       <!-- Gratis -->
       <div class="aviso left" style="background:url(/sites/all/themes/empleos/img/a-gratis.gif)top no-repeat; height:195px">
       		<ul class="left" style="margin-left:22px; margin-top:45px;">
            <li ><a style=" color:#fff" href="#">lalala</a></li>
            <li ><a style=" color:#fff" href="#">lalala</a></li>
            </ul>
       		<div class="price" style="background:url(/sites/all/themes/empleos/img/price-gratis.png)top no-repeat;"></div>
            <a href="#"><div class="btn" style="background:url(/sites/all/themes/empleos/img/btn-a-simple.png) no-repeat; top:63px"></div></a>
       </div>
       </div>
