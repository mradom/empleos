  ...
  <div id="midle">
    ...
    <?php print $content;?>
	  <?php if (arg(1)<>'add' and arg(2)<>'edit' and arg(2)<>'delete') {
		  print "<div class='btn_gral b'><a href='/node/add/p-referencia'>Agregar</a></div>&nbsp;&nbsp;";
	      print "<div class='btn_gral r'><a href='/miobjetivolaboral/me'>Paso siguiente</a></div><br /><br />";
		  }?>
    <div class="clr"></div>
    <!-- CENTRAL -->
