    ...
    <div id="central_column">
  	      <?php //include("include/lista_rubros.php");?>
			  ...
			  if ( arg(1)=='') {
    		      ...
    		      print '<div class="corner_blue">Avisos por Provincias</div></div>';
        		  print '<div class="box center">'; 
			      
				  $b_ramo=get_vocabulary_by_name('Provincias');
...
function get_child_terms($parent, $vid) {
    ...
    while ($aterm = db_fetch_object($terms)) {
        ...
        $output .= l("$aterm->name", "provincia/$aterm->tid") . " ("
...
//print '['.$sql.']';
	...
	if(mysql_num_rows($rs) > 0){
	  ...
	  print '<div><p>No se encontraron avisos en este Provincia. Click <a href="/provincia">aquí</a> para ver todos los Provincia.</p></div>';
	}
