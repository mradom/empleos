# $Id: README.txt,v 1.1 2008/07/23 23:37:03 greenskin Exp $
...
To allow your module to provide a tab in the Share popup, you will need to implement the following two hooks:
